...
function make() {
  ...
  newrecord[/* render */9] = (function (self) {
      return ReasonReact.element(/* None */0, /* None */0, GoogleData$EasyDrive.make((function (user, login, get_files_in_folder, get_recent_files) {
                        return ReasonReact.element(/* None */0, /* None */0, App$EasyDrive.make(user, self[/* state */2][/* current_file */1], "root", (function (file) {
